            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  @if(\File::exists(public_path('upload/images/profileimage/thumbnail/'.$data->image)) && !empty($data->image))
                  <img class="profile-user-img img-fluid img-circle border-0" src="{{asset('upload/images/profileimage/'.$data->image)}}" alt="User profile picture" style="width: 100;height: 100px;">
                  @else
                  <img class="profile-user-img img-fluid img-circle border-0" src="{{asset('upload/default.png')}}" alt="User profile picture" style="width: 100;height: 100px;">
                  ...
                  <div class="active tab-pane" id="profile">
                    <form id="profileForm" class="form-horizontal" action="{{route('profile.update')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                          <input type="email" name="email" class="form-control numbers" id="email" placeholder="Email" value="{{$data->email}}">
                          <small class="errorTxt1">
                            <div id="uname-error" class="error text-red">{{ $errors->first('email') }}</div>
                          </small>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10 form-group">
                          ...
                          <small class="errorTxt1">
                          <div id="uname-error" class="error text-red">{{ $errors->first('profileimage') }}</div>
                        </small>
                        </div>
                      </div>
